...
type Error struct {
	...
	TextError string `protobuf:"bytes,1,opt,name=textError,proto3" json:"textError,omitempty"`
...
func (x *Error) GetTextError() string {
	if x != nil {
		return x.TextError
	}
	return ""
...
var file_questionnaire_proto_rawDesc = []byte{
	...
	0x1c, 0x0a, 0x09, 0x74, 0x65, 0x78, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x09, 0x74, 0x65, 0x78, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x12, 0x0a,
